...
const TOOLS = [
  {
    ...
    description:
      ...
      "- intelligence_records (needs `query`): the matching CONTENT itself — ranked posts/videos with platform, tags, engagement, similarity. Use when you want the actual source material to read or cite.\n" +
      ...
      "For intelligence_records / campaign_brief / llm_context the API requires an explicit time window (7d | 30d | all); if you don't set filters.window this server defaults it to 'all'.\n" +
