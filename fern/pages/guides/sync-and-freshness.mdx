...
| `7d` | Last 7 days |
| `30d` | Last 30 days |
| `all` | No time filter (live retrieval jobs only) |
...
Live retrieval jobs (`POST /intelligence/jobs`) accept `7d`, `30d` or `all`, and the window is required — there is no default. See [Intelligence Jobs](./intelligence-jobs.mdx).
