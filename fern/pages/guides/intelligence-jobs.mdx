...
- `limit`: the number of records to retrieve, `100`–`50000`. **Required** — there is no default; omitting it returns 400. Jobs are billed per record, so the limit is how you choose your spend (`1000` is a sensible starting point).
