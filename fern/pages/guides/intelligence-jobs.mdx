...
|---|---|---|---|
| `intelligence_search` | `query` + filters | Ranked content + retrieval diagnostics | 15 min |
| `intelligence_discover` | `query` + filters | Search + narratives + analytics + LLM insights | 1 h |
| `campaign_brief` | `campaign` object | Persisted LLM-generated brief | 6 h |
| `llm_context` | `campaign` object | Ephemeral LLM-ready context bundle | 6 h |
