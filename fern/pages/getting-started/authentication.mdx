...
Intelligence jobs are metered in credits (1 credit = $2.00), purchased from the dashboard's [billing page](https://app.kinetk.ai/billing) — see the billing notes in the [Intelligence jobs guide](../guides/intelligence-jobs.mdx).
